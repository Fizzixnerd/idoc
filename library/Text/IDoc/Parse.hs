...
listItem :: forall e s m labelType a . (ErrorComponent e, Stream s, Token s ~ Char, HardEnd e s m (a, labelType), BadEnd e s m (a, labelType), ILS e s m labelType) => 
